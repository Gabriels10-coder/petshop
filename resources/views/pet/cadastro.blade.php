        ...
        <section  class="container distnavbar ">
            <div class="d-flex flex-column align-items-center ">
                <div class="col-6 ">
                    ...
                    <input class="form-control" type="text" name="nome" onkeyup="validacaoPets()" placeholder="Insira o nome  do seu animal" id="nomeanimal" />
                    <p id="erro1"></p>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <input class="form-control" type="number"  name="peso" placeholder="Insira o peso atual do animal" id="peso" />
                </div>
                <div class="col-6">
                    <label class="form-label">Idade:</label>
                    <input class="form-control" type="number" name="idade"  placeholder="Insira a idade do seu animal" id="idade" />
